...
_internal_name=GE-Proton9-10-rtsp12-hotfix
...
SRC_URI="https://github.com/SpookySkeletons/proton-ge-rtsp/releases/download/rtsp6-hotfix/${_internal_name}.tar.gz -> ${_internal_name}.tar.gz"
