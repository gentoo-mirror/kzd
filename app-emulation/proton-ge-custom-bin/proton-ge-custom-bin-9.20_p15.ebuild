...
_internal_name=GE-Proton9-20-rtsp15
...
SRC_URI="https://github.com/SpookySkeletons/proton-ge-rtsp/releases/download/${_internal_name}-1/${_internal_name}.tar.gz -> ${_internal_name}.tar.gz"
