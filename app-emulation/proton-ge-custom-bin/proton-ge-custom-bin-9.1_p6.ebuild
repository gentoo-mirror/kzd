...
_internal_name=GE-Proton9-1-rtsp6
...
SRC_URI="https://github.com/SpookySkeletons/proton-ge-rtsp/releases/download/${_internal_name}-fix/${_internal_name}.tar.gz -> ${_internal_name}.tar.gz"
