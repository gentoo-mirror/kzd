...
# would require unmask of openssl 1.1.1w for entire system and linkage against it...
#<dev-libs/openssl-2[${MULTILIB_USEDEP}]
# would require system building against purely ffmpeg 4.4, which blocks programs like blender, gst-plugins, etc.
